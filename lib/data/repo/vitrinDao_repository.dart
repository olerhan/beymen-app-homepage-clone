...
class Vitrin1DaoRepository {
  Future<List<VitrinModel>> vitrin1DaodanYukle() async {
    ...
    var v2 = VitrinModel(id: 2, ad: "Resim2", resimUrl: "https://images.unsplash.com/photo-1599844127201-f01a996b358c?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&dl=zoran-zonde-stojanovski-Dw-oxX8ZM44-unsplash.jpg&w=640");
    var v3 = VitrinModel(id: 3, ad: "Resim3", resimUrl: "https://images.unsplash.com/photo-1599844127201-f01a996b358c?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&dl=zoran-zonde-stojanovski-Dw-oxX8ZM44-unsplash.jpg&w=640");
